...
public class IdleState : State
{
    ...
    public IdleState(StateMachine stateMachine, Animator animator, Mover mover, EnemyVision enemyVision, float waitTime, float sqrAttackDistance) 
        : base(stateMachine, animator, mover)
    {
        _waitTime = waitTime;
        Transitions = new Transition[]
        {
            new SeeTargetTransition(stateMachine, enemyVision, mover.transform, sqrAttackDistance),
